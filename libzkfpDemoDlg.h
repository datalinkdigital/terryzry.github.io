...
#define ENROLLCNT 3
#define WM_MYMSGCLEAR WM_USER+8
...
public:
	...
	BOOL m_bRegister;
	BOOL m_bStopThread;
	int m_enrollIdx;	// 识别后辨认出人名
	CString m_strIdtifyName;
	...
	afx_msg void OnBnClickedButAdmin();
	afx_msg void OnBnClickedMfcBtnConn();
	afx_msg void OnBnClickedMfcBtnDisConn();
	afx_msg LRESULT OnMymsgclear(WPARAM wParam, LPARAM lParam);
	CFont m_editFont;
	CString m_strIdtifyRank;
	CString m_strIdtifyId;
	CString m_strIdtifyTid;
	unsigned int m_iIdentfyTid;
